...
DONACIONES_SPRITES = {
    "comida":   "assets/donacion_comida.png",
    "libros":   "assets/donacion_libros.png",
    "juguetes": "assets/donacion_juguetes.png",
}
...
ICONO_PASOS = "assets/icono_pasos.png"
ICONO_RELOJ = "assets/icono_reloj.png"
ICONO_LLAVE = "assets/icono_llave.png"
PANEL_MARCO = "assets/panel_marco.png"

# Un ícono por habilidad, con la misma clave que usa PERSONAJES_FAMILIA
ICONOS_HABILIDAD = {
    "carga":   "assets/icono_carga.png",
    "rampa":   "assets/icono_rampa.png",
    "guia":    "assets/icono_guia.png",
    "alcance": "assets/icono_alcance.png",
}
...
OBJETOS_MULTIJUGADOR = [
    {"id": "foto",       "archivo": "assets/objeto_foto.png",
    ...
    {"id": "tornillo",   "archivo": "assets/objeto_tornillo.png",
    ...
    {"id": "mochila",    "archivo": "assets/objeto_mochila.png",
    ...
    {"id": "farol",      "archivo": "assets/objeto_farol.png",
    ...
    {"id": "alcanzador", "archivo": "assets/objeto_alcanzador.png",
    ...
    {"id": "rueda",      "archivo": "assets/objeto_rueda.png",
    ...
    {"id": "herramientas", "archivo": "assets/objeto_herramientas.png",
    ...
    {"id": "taza",       "archivo": "assets/objeto_taza.png",
